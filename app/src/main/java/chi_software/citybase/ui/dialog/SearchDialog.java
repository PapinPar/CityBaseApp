...
public class SearchDialog extends DialogFragment implements MultiSelectionSpinner.OnMultipleItemsSelectedListener {
    ...
    private LinearLayout radioGroupSearch;

    private MenuSearch menuSearch;
    private GetSpinnerListener getSpinnerListener;

    public void show(Activity activity, GetSpinnerListener getSpinnerListener, MenuSearch menuSearch, List<String> mTypeSelected, List<String> mAreaSelected, List<String> mPunktSelected, String mTable) {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        radioGroupSearch = (LinearLayout) view.findViewById(R.id.radioGroupSearch);
